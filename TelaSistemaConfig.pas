...
type
  TIWTelaSistemaConfig = class(TIWAppForm)
    IWTemplateProcessorHTMLTTelaSistemaConfig: TIWTemplateProcessorHTML;
    ...
    IWDatabase: TIWEdit;
    IWId: TIWEdit;
    procedure IWTemplateProcessorHTMLTTelaSistemaConfigUnknownTag(const AName: string; var VValue: string);
...
uses RenderHtml, ServerController, IW.Common.AppInfo;
...
procedure TIWTelaSistemaConfig.IWAppFormCreate(Sender: TObject);
begin
...
procedure TIWTelaSistemaConfig.IWAppFormShow(Sender: TObject);
begin
...
procedure TIWTelaSistemaConfig.IWBtnConfirmarAsyncClick(Sender: TObject; EventParams: TStringList);
var
Erro,img : String;
begin
...
procedure TIWTelaSistemaConfig.IWBtnEditarAsyncClick(Sender: TObject; EventParams: TStringList);
begin
          WebApplication.ShowMessage( 'editar ', smAlert );
end;

procedure TIWTelaSistemaConfig.IWBtnSalvarUserMasterAsyncClick(Sender: TObject; EventParams: TStringList);
begin
...
procedure TIWTelaSistemaConfig.IWBtnTestarConexaoAsyncClick(Sender: TObject; EventParams: TStringList);
begin
...
procedure TIWTelaSistemaConfig.IWTemplateProcessorHTMLTTelaSistemaConfigUnknownTag(const AName: string; var VValue: string);
begin
  if AName = 'ano' then
  begin
