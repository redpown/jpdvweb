...
var
  ...
  zq_Connection: TZConnection;
   ...
   Procedure GeraConectionCds(Host: TIWEdit; Port: TIWEdit; Schema: TIWEdit ; Database:TIWEdit ; Protocolo:TIWEdit ;Usuario: TIWEdit;Senha: TIWEdit);
   function conectar(): String;
   function Cad_UsuarioMaster(Usuario: TIWEdit; Senha: TIWEdit): String;
